...
func init() {
	...
	maskCmd.Flags().StringP("policyName", "n", "",
		"Name of the policy to be used to masking")
	maskCmd.Flags().StringP("tokenData", "d", "",
		"Data to be masked")

	maskCmd.MarkFlagRequired("policyName")
	maskCmd.MarkFlagRequired("tokenData")
}
